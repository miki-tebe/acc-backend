...
- [Hydra - Zero Config API Boilerplate with Laravel Sanctum](#hydra---zero-config-api-boilerplate-with-laravel-sanctum)
  ...
  - [Tutorial](#tutorial)
    ...
    - [Generate Model, Migration and Controller using plop](#generate-model-migration-and-controller-using-plop)
...
### Generate Model, Migration and Controller using plop

To generate a model, migration and controller, you can use the plop command.

```shell
npm run gen
```
Then add the following line to your newly created migration file.
